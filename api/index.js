...
app.get('/api/getPostData', (req, res) => {
    res.json({ value: storedPostDataValue });
});

app.post('/api/postSuhu', (req, res) => {
    console.log(req.body);
    storedSuhu = req.body;
    res.status(200).send('Data received');
});

app.get('/api/getSuhu', (req, res) => {
    res.json(storedSuhu); // Send the stored data
});

app.get('/api/getKipas', (req, res) => {
    res.json(kipasData); // Send the stored data
});

app.post('/api/postRfid', (req, res) => {
    let { id } = req.body;
...
app.post('/api/hantarKipas', (req, res) => {
...
app.post("/api/postUID", async (req, res) => {
...
app.get("/api/getEntryRecord", async (req, res) => {
    try {
